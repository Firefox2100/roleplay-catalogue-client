...
export function AssistantDrawer({ open, onClose, selected, worldOverview, context, draftPrompt, onDraftPromptUsed, providerConfigured, onAccept, t }: {
  open: boolean;
  onClose: () => void;
