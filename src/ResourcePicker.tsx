...
export function ResourcePicker({ configured, selected, onSelected, onOpenSettings, t }: { configured: boolean; selected: SelectedCharacter | null; onSelected: (value: SelectedCharacter) => void; onOpenSettings: () => void; t: (key: MessageKey) => string }) {
